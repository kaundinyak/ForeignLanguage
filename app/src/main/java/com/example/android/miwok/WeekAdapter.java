...
public class WeekAdapter extends ArrayAdapter<Word> {

    public WeekAdapter(Activity context, ArrayList<Word> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        weekTextView.setText(currentWord.getmFrenchTranslation());
