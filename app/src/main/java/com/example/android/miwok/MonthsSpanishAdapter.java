...
public class MonthsSpanishAdapter extends ArrayAdapter<WordSpanish> {

    public MonthsSpanishAdapter(Activity context, ArrayList<WordSpanish> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null) {
            ...
            listItemView = LayoutInflater.from(getContext()).inflate(
                    ...
                    spanish_month_item, parent, false);
        ...
        monthTextView.setText(currentWord.getmSpanishTranslation());
