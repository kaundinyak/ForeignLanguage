...
public class WeekSpanishAdapter extends ArrayAdapter<WordSpanish> {

    public WeekSpanishAdapter(Activity context, ArrayList<WordSpanish> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null) {
            ...
            listItemView = LayoutInflater.from(getContext()).inflate(
                    ...
                    spanish_week_item, parent, false);
        ...
        weekTextView.setText(currentWord.getmSpanishTranslation());
