...
public class MonthAdapter extends ArrayAdapter<Word> {

    public MonthAdapter(Activity context, ArrayList<Word> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        monthTextView.setText(currentWord.getmFrenchTranslation());
